  ...
  <body>
    <div class="container">
      ...
      <div class="main">
        ...
        <form class="form-regist" action="processRegist.jsp" method="post">
          <span style="display:inline-block; width:80px">아이디</span><input type="text" class="form-input-text" name="userId" value="" placeholder="" /><br><br>
